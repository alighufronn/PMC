...
<div class="row">
    <div class="col-md-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="dropdown-divider"></div>
                <div class="icheck-warning d-inline">
                    <input type="checkbox" id="hsem">
                    <label for="hsem">
                        <span style="font-weight: lighter;">Diperiksa [HSE-M]: </span>
                        <span>Lorem, ipsum.</span>
                    </label>
                    <sub class=" float-right text-gray mt-2">dd/mm/yyyy</sub>
    ...
    <div class="col-md-9">
        <div class="card">
            ...
            <div class="card-body">
                <table id="tambah-rap-hse-rev" class="table table-sm display" style="width: 100%;">
...
<script>
    $(function() {
        var table = $('#tambah-rap-hse-rev').DataTable({
            "paging": false,
            "lengthChange": false,
            "searching": false,
            "info": false,
