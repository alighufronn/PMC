        ...
        <div class="row">
            ...
            <div class="col-md-2 col-sm-4">
                <div class="form-group">
                    ...
                    <textarea name="" id="" rows="2" class="form-control form-control-sm"></textarea>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-md-9">
        <div class="card">
            ...
            <div class="card-body">
                <table id="tambah-alatkerja-rev" class="table table-sm display" style="width: 100%;">
...
<script>
    $(function() {
        var table = $('#tambah-alatkerja-rev').DataTable({
            "paging": false,
            "lengthChange": false,
            "searching": false,
            "info": false,
